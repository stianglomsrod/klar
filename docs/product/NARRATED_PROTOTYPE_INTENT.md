...
| --- | --- | --- | --- |
| 00:10 | Læreren trenger én oversikt med nylige elever, aktiv hjelpekø, hurtighandlinger og elevaktivitet. | Utsatt helhet; informasjonsarkitekturen er innarbeidet. | [`UI_UX_REFERENCE.md`](./UI_UX_REFERENCE.md). Dagens lærerflate er ikke det ferdige dashboardet. |
...
| 01:08 | Klasse-, gruppe- og elevflater skal gi raske innganger til oppfølging og individuell støtte. | Utsatt helhet. | [E05](../epics/E05_STAFF_ACCESS_AND_SUBSTITUTES.md) eier tilgangsgrensen; komplett administrasjons-UX har ikke eget ferdig kontrollpunkt. |
...
| 08:24–08:45 | Fortelleren går opp i nivå for å vise andre belønningstyper. En læreropprettet belønning vises som kupong eleven kan velge å bruke. | Utsatt kuponglivsløp. Videoen avklarer ikke bevaring etter XP-reversering eller engangssemantikk. | [E02](../epics/E02_PROGRESS_AND_REWARDS.md); domenekontrakten § 12 holder innløsning og retting åpent. |
...
4. Det eksakte livsløpet for kuponginnløsning, inkludert hvem som kan markere
   den brukt og hvordan feilinnløsning kan rettes uten dobbel bruk.
