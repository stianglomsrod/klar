...
export function getE2ECredentials() {
  return {
    ...
    rewardStudentCode: required("KLAR_E2E_REWARD_STUDENT_CODE"),
    rewardStudentPassword: required("KLAR_E2E_REWARD_STUDENT_PASSWORD"),
    rewardVisualStudentCode: required("KLAR_E2E_REWARD_VISUAL_STUDENT_CODE"),
    rewardVisualStudentPassword: required("KLAR_E2E_REWARD_VISUAL_STUDENT_PASSWORD"),
    progressVisualStudentCode: required("KLAR_E2E_PROGRESS_VISUAL_STUDENT_CODE"),
    progressVisualStudentPassword: required("KLAR_E2E_PROGRESS_VISUAL_STUDENT_PASSWORD"),
    ...
    helpStaffEmail: "help-staff@e2e.klar.invalid",
    helpStaffPassword: required("KLAR_E2E_SUBSTITUTE_PASSWORD"),
  };
}
