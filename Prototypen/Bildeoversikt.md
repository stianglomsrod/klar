...
| `E levelupmodal med valgmuligheter NY.jpg`, `E *kupong*.jpg`, `E *blomst*.jpg`, `E fargelegging av nytt kronblad NY.jpg` | **Intensjon + visuell referanse** | Et nivå kan gi ett varig valg; blomsterhage og kuponger kan være rolige, valgfrie motivatorer. | Farming, gjentatt stor feiring, obligatorisk spillmodus eller kontinuerlig animasjon. |
...
| `L visning av quizsvar med mulighet til å spille av elevens innspilte lyd, og mulighet for reaksjon og kommentar.png` | **Visuell referanse** | Lærer kan se valgfritt elevmedia, gi kompakt respons og sende arbeid i retur. | Quiz som obligatorisk oppgavetype eller fritekst som unødvendig elevjournal. |
