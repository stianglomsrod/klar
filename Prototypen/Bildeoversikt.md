...
| `E quiz.jpg`, `E quiz med innspilt lyd.jpg`, `L oppgaveoppretting quiz.jpg` | **Intensjon + visuell referanse** | Quiz/test er en egen oppgavetype med ett spørsmål om gangen, tydelig lilla rom, opplesing, tekst/valg og valgfritt lydsvar. Lærerbyggeren skal være versjonert og gjenbrukbar. | Automatisk «riktig»-markering uten fasit, resultatbasert XP, custom controls uten native semantikk eller quiz som obligatorisk dokumentasjon av vanlig skolearbeid. |
| `L hjelpekøliste.png`, `L flytter elev opp på hjelpekølista uten at elevene trenger å vite det jf WS3 - Dette var en bug som ble en feature.jpg` | **Intensjon** | Ansatte kan se, løse og omprioritere køen uten å eksponere prioriteringen for eleven. Flere ansatte kan dele køen, overføre arbeid og forlate egne oppdateringer uten å stenge for resten. | Drag-and-drop som eneste metode; kønummeret i ansattflaten er ikke elevsannhet; én lærers uttreden må ikke tolkes som global stenging. |
| `E levelupmodal med valgmuligheter NY.jpg`, `E *kupong*.jpg`, `E *blomst*.jpg`, `E fargelegging av nytt kronblad NY.jpg` | **Intensjon + visuell referanse** | Et nivå kan gi ett belønningsvalg. Bildene viser valg, pågående blomst og hageinngang; E09 viderefører dette til flerfargede strøk, femkronbladblomst og en levende, personlig hage. Varighet, én-per-milepæl og anti-farming følger domenekontrakten, ikke bildene alene. | Farming, gjentatt stor feiring, obligatorisk spillmodus, ensfarget prototype som sluttambisjon eller bevegelse uten pause/reduced-motion-alternativ. |
| `E avatarvelger.jpg`, `E hamburgermeny.jpg` | **Visuell referanse + beslutningsport** | Eleven kan få en gjenkjennelig, privat identitet og en stabil dock/navigasjon for dag, hjelp og belønning. | Emoji-rutenettet som automatisk sluttvalg, offentlig profil, kjønnet standard, virtuell butikk eller avatar som krever stell. E10 krever prototypetest av flere identitetsretninger. |
